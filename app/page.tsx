  ...
  return (
    <div className=" flex  flex-col  items-center">
      <main className="text-center pt-32">
        {/* Title */}
        <h1 className="text-5xl font-bold flex flex-col gap-3 text-gray-900 mb-4">
        ...
        <BlurFade delay={0.8}>
          ...
          <BlurFade delay={0.8}>
            {!session && <p className="text-sm text-gray-500 mt-4">Try free</p>}
          </BlurFade>
        </BlurFade>
      </main>
            ...
            <Accordion type="single" className="w-full" collapsible>
              ...
              <BlurFade delay={2.2}>
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent className="text-gray-600">
                    Yes, we offer a 7-day free trial with no credit card
                    required.
                  </AccordionContent>
                </AccordionItem>
              </BlurFade>
              ...
              <BlurFade delay={2.3}>
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent className="text-gray-600">
                    Absolutely! GetItDone supports real-time sync across all
                    your devices.
                  </AccordionContent>
                </AccordionItem>
              </BlurFade>
              ...
              <BlurFade delay={2.4}>
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent className="text-gray-600">
                    You can upgrade to a premium plan via your account settings
