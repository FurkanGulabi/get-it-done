...
const page = () => {
  return (
    <div className="h-full w-full container mx-auto flex flex-col gap-2">
      <h1 className="text-3xl font-extrabold mb-10">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p className="text-muted-foreground mt-2">
            <strong>Application</strong> refers to GetItDone, the software
        ...
        <li>
          <p className="text-muted-foreground mt-2">
            ...
            this Agreement) refers to GetItDone.
          </p>
        </li>
        <li>
          <p className="text-muted-foreground mt-2">
        ...
        <li>
          <p className="text-muted-foreground mt-2">
            <strong>Website</strong> refers to GetItDone, accessible from{" "}
            <a
              href="https://getitdone.com"
      ...
      <ul>
        <li>
          <p className="text-muted-foreground mt-2">Email address</p>
        </li>
        <li>
          <p className="text-muted-foreground mt-2">First name and last name</p>
        </li>
        <li>
          <p className="text-muted-foreground mt-2">Usage Data</p>
        </li>
      </ul>
      <h4>Usage Data</h4>
      <p className="text-muted-foreground mt-2">
      ...
      <ul>
        <li>
          ...
          <p className="text-muted-foreground mt-2">Type: Session Cookies</p>
          <p className="text-muted-foreground mt-2">Administered by: Us</p>
          <p className="text-muted-foreground mt-2">
        ...
        <li>
          ...
          <p className="text-muted-foreground mt-2">Type: Persistent Cookies</p>
          <p className="text-muted-foreground mt-2">Administered by: Us</p>
          <p className="text-muted-foreground mt-2">
      ...
      <ul>
        <li>
          ...
          <a
            href="http://getitdone.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            http://getitdone.com/contact
          </a>
        </li>
      </ul>
    </div>
